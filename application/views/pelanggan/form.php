      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="<?php echo site_url('pelanggan/create');?>">Add Customer</a></li>
            <li role="presentation"><a href="<?php echo site_url('pelanggan');?>">List Customer</a></li>
          </ul>
            ...
            <?php } ?>
              <div class="box-body">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="col-sm-4 control-label" for="kode">Customer Code</label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="<?php echo !empty($pelanggan) ? $pelanggan['customer_name'] : '';?>" name="customer_name" placeholder="Enter Name" id="name" class="form-control" required/>
                    </div>
                  </div>
                  <div class="form-group">
              ...
              <div class="box-footer">
                <div class="col-md-3 col-md-offset-4">
                  <a class="btn btn-danger" href="<?php echo site_url('pelanggan');?>">Cancel</a>
