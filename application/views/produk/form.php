      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="<?php echo site_url('produk/create');?>">Add Product</a></li>
            <li role="presentation"><a href="<?php echo site_url('produk');?>">List Product</a></li>
          </ul>
		  <div class="box box-info">
            ...
            <?php } ?>
              <div class="box-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="col-sm-4 control-label" for="address">Sale Price Type 1</label>
                    <div class="col-sm-8">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="col-sm-4 control-label" for="address">Sale Price Type 2</label>
                    <div class="col-sm-8">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="col-sm-4 control-label" for="address">Sale Price Type 3</label>
                    <div class="col-sm-8">
              ...
              <div class="box-footer">
                <div class="col-md-3 col-md-offset-4">
                  <a class="btn btn-danger" href="<?php echo site_url('produk');?>">Cancel</a>
